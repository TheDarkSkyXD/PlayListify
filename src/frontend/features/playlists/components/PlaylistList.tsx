...
import { useDeletePlaylist } from '../../../services/query/hooks';
...
import { SortAsc, Clock, AlignJustify, Search, AlertCircle, Trash2, Play } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {sortedAndFilteredPlaylists.map((playlist) => (
            <Card key={playlist.id} className="overflow-hidden">
              ...
              <div className="relative pb-[56.25%] bg-gray-200 dark:bg-gray-700 overflow-hidden">
                {playlist.thumbnail ? (
                  <img
