...
interface RenamePlaylistModalProps {
  ...
  onConfirm?: (newName: string) => void; // For backward compatibility
  currentName: string;
  playlistName?: string; // For backward compatibility
  isLoading?: boolean;
}
...
export const RenamePlaylistModal: React.FC<RenamePlaylistModalProps> = ({
  ...
  // Use currentName if provided, otherwise fallback to playlistName for backward compatibility
  const actualName = currentName || playlistName || '';
