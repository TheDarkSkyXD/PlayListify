...
- [ ] Implemented fallback mechanism for image loading (including private/deleted video placeholders)
- [ ] Added development asset handling for static files (placeholder added)
